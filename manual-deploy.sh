...
wait_with_countdown 15 "Starting deployment in 15 seconds..."
...
echo ""
echo -e "  ${YELLOW}TRAINER NOTE:${RESET}"
...
echo ""
wait_with_countdown 15 "Simulating SSH connection..."
...
echo ""
wait_with_countdown 15 "Navigating to project directory..."
...
echo ""
wait_with_countdown 15 "Pulling latest code from GitHub..."
...
echo ""
wait_with_countdown 15 "Building Docker image (theme: diwali)..."
...
echo ""
wait_with_countdown 15 "Stopping old container..."
...
echo ""
wait_with_countdown 15 "Removing old container..."
...
echo ""
wait_with_countdown 15 "Starting new container..."
...
echo ""
wait_with_countdown 15 "Running health check..."
...
echo ""
wait_with_countdown 15 "Pushing image to Docker Hub..."
